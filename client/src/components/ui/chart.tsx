...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    formatter?: (value: string | number, name: string | number, item: TooltipPayloadItem, index: number, payload: TooltipPayloadItem[]) => React.ReactNode
    color?: string
  }
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        const labelValue = typeof value === "string" || typeof value === "number" ? value : String(value ?? "")
        return (
